...
class WithdrawModel extends AbstractModel
{
    ...
    public function updateStatus ($params) {
        ...
        $this->db->exec($sql, array('withdraw_status' => $params['withdraw_status'],'withdraw_remark' => $params['withdraw_remark'] ?? '','change_time' => date('Y-m-d H:i:s'),'withdraw_id' => $params['withdraw_id']));
    }
}