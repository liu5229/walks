...
//            }
    ...
    public function getAdAction() {
        ...
        $sql = 'SELECT advertise_type type, advertise_name name, CONCAT(?, advertise_image) img, advertise_url url FROM t_advertise_old WHERE advertise_location = ? AND advertise_status = 1 ORDER BY advertise_id DESC LIMIT ' . $adCount[$this->inputData['location']];
